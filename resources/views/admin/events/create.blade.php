...
<div class="animated fadeIn">
    ...
    <form action="{{route('admin.event.save')}}" method="post" enctype="multipart/form-data">
        {!! csrf_field() !!}
        <div class="card">
            <div class="card-header"><strong>Create Event</strong><small>    </small></div>
                <div class="card-body card-block">
                    ...
                    <div class="row form-group">
                        <div class="col col-md-3"><label for="select" class=" form-control-label">Event Date</label></div>
                           ...
                           <input class="form-control datetimepicker" type="text" name="eventDate" current-time="{{date('Y-m-d')}}" required>
                           </div>
                    </div>
                    <div class="row form-group">
