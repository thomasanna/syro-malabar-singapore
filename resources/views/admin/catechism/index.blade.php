 ...
 <div class="breadcrumbs">
            <div class="col-sm-4">
                ...
                <div class="page-header float-right">
                    <div class="page-title">
                       <h1><a href="{{route('admin.catechism.create')}}" class="btn btn-primary"><i class="fa fa-plus" aria-hidden="true"></i>
                        Upload File</a></h1>
                    </div>
                </div>
            </div>
                ...
                <div class="row">
                    ...
                    <div class="col-md-12">
                        <div class="card">
                            ...
                            <div class="card-body">
                                <table id="bootstrap-data-table-export" class="table table-striped table-bordered" fetch="{{route('admin.catechism.data')}}"
                                  token="{{ csrf_token() }}">
                                    <thead>
                                        <tr>
                                           <!--  <th>No</th> -->
